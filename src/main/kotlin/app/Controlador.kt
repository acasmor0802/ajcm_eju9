...
class Controlador(
    ...
    private fun crearUsuarios() {
        ...
        try {
            ...
            connection.commit()
            consola.mostrar("Usuarios creados correctamente.")
        } catch (e: Exception) {
            try {
                connection.rollback()
                consola.mostrarError("Error al crear usuarios: ${e.message}")
            } catch (ex: Exception){
                consola.mostrarError("Error en el rollback")
                consola.mostrarError("Error original: ${e.message}")
            }
        } finally {
    ...
    private fun crearPedidos() {
        ...
        try {
            ...
            connection.commit()
            consola.mostrar("Pedidos creados correctamente.")
        } catch (e: Exception) {
            try {
                connection.rollback()
    ...
    private fun crearLineas() {
        ...
        try {
            ...
            connection.commit()
            consola.mostrar("Líneas creadas correctamente.")
        } catch (e: Exception) {
            try {
                connection.rollback()
                consola.mostrarError("Error al crear líneas: ${e.message}")
            } catch (ex: Exception) {
                consola.mostrarError("Error en el rollback")
                consola.mostrarError("Error original: ${e.message}")
            }
    ...
    private fun crearProductos() {
        ...
        try {
            ...
            connection.commit()
            consola.mostrar("Productos creados correctamente.")
        } catch (e: Exception) {
            try {
                connection.rollback()
    ...
    private fun eliminarNombre() {
        ...
        try {
            ...
            connection.commit()
            consola.mostrar("Usuario eliminado con éxito.")
        } catch (e: Exception) {
            try {
                connection.rollback()
    ...
    private fun eliminarxPrecio() {
        ...
        try {
            ...
            val precio = consola.leer("Precio para eliminar productos: ").toDoubleOrNull()
            if (precio != null) {
                servicioProducto.eliminarPorPrecio(precio)
                connection.commit()
                consola.mostrar("Productos eliminados por precio.")
            } else {
